        ...
        semverlite exists to solve a narrow, inspectable developer-tooling problem:
        Strict semantic-versioning parser, comparator, and bumper for Python. Zero dependencies.
        ...
        Topics: comparator, parser, python, semver, versioning, zero-dependencies
